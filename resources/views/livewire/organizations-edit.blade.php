    ...
    <template x-if="$wire.feedback">
        <div x-data="{
            ...
            <div class="flex items-center">
                ...
                <div class="py-4 text-white text-sm font-medium" x-html="$wire.feedback">
                </div>
            </div>
                ...
                <form wire:submit="save">
                    ...
                    <div class="flex items-center px-8 py-4 bg-gray-50 border-t border-gray-100"
                        ...
                        <button class="flex items-center btn-indigo ml-auto"
                                @click="click = true; setTimeout(() => click = false, 2000)"
                                type="submit">
                            <span :class="click ? 'btn-spinner' : 'hidden'" class="mr-2"></span>
                            Update Organization
                        </button>
                    </div>
                </form>
